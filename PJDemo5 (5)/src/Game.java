...
public class Game {
    ...
    */
    ...
    {
        File file=new File("C:\\Users\\xuan_\\IdeaProjects\\PJDemo5\\"+name+"\\"+"/"+mode);
        if(file.exists()&&file.isFile())
            file.delete();

        File dir=new File("C:\\Users\\xuan_\\IdeaProjects\\PJDemo5\\"+name);
        if(!dir.exists())
            dir.mkdir();
        File dirMode=new File("C:\\Users\\xuan_\\IdeaProjects\\PJDemo5\\"+name+"\\"+mode);
        if(!dirMode.exists())
            dirMode.mkdir();

        try {
            fout = new FileOutputStream("C:\\Users\\xuan_\\IdeaProjects\\PJDemo5\\"+name+"\\"+mode+"\\temp.txt");
        ...
        try
        {
            fout = new FileOutputStream("C:\\Users\\xuan_\\IdeaProjects\\PJDemo5\\"+name+"\\"+mode+"\\posrow.txt");
            dout = new DataOutputStream(fout);
        ...
        try
        {
            fout = new FileOutputStream("C:\\Users\\xuan_\\IdeaProjects\\PJDemo5\\"+name+"\\"+mode+"\\poscolumn.txt");
            dout = new DataOutputStream(fout);
        ...
        try
        {
            ...
            fout = new FileOutputStream("C:\\Users\\xuan_\\IdeaProjects\\PJDemo5\\"+name+"\\"+mode+"\\cells.txt");
            dout = new DataOutputStream(fout);
            for (int i = 0; i <= rows; i++)
            {
                for (int j = 0; j <= columns-1; j++)
                {
                    fout = new FileOutputStream("C:\\Users\\xuan_\\IdeaProjects\\PJDemo5\\"+name+"\\"+mode+"\\cells" + String.valueOf(i) + String.valueOf(j) + ".txt");
                    dout = new DataOutputStream(fout);
        ...
        try
        {
            FileOutputStream fileOut = new FileOutputStream("C:\\Users\\xuan_\\IdeaProjects\\PJDemo5\\"+name+"\\"+mode+"\\current.txt");
    ...
    public void readRecord(String name,String mode)
    {
        try
        {
            fin = new FileInputStream("C:\\Users\\xuan_\\IdeaProjects\\PJDemo5\\"+name+"\\"+mode+"\\temp.txt");
        ...
        try
        {
            fin = new FileInputStream("C:\\Users\\xuan_\\IdeaProjects\\PJDemo5\\"+name+"\\"+mode+"\\posrow.txt");
            din = new DataInputStream(fin);
        ...
        try
        {
            fin = new FileInputStream("C:\\Users\\xuan_\\IdeaProjects\\PJDemo5\\"+name+"\\"+mode+"\\poscolumn.txt");
            din = new DataInputStream(fin);
        ...
        try
        {
            fin = new FileInputStream("C:\\Users\\xuan_\\IdeaProjects\\PJDemo5\\"+name+"\\"+mode+"\\cells.txt");
            din = new DataInputStream(fin);
            ...
            for (int i = 0; i <= rows; i++)
            {
                for (int j = 0; j <= columns-1; j++)
                {
                    fin = new FileInputStream("C:\\Users\\xuan_\\IdeaProjects\\PJDemo5\\"+name+"\\"+mode+"\\cells" + String.valueOf(i) + String.valueOf(j) + ".txt");
                    din = new DataInputStream(fin);
        ...
        try
        {
            FileInputStream fileIn = new FileInputStream("C:\\Users\\xuan_\\IdeaProjects\\PJDemo5\\"+name+"\\"+mode+"\\current.txt");
    ...
    public void writeRandomBlock(String name)
    {
            try
            {
                FileOutputStream fileOut = new FileOutputStream("C:\\Users\\xuan_\\IdeaProjects\\PJDemo5\\"+name+"\\randomGameMode\\randomBlock1.txt");
                ObjectOutputStream objectOut = new ObjectOutputStream(fileOut);
        ...
        try
        {
            FileOutputStream fileOut = new FileOutputStream("C:\\Users\\xuan_\\IdeaProjects\\PJDemo5\\"+name+"\\randomGameMode\\randomBlock2.txt");
            ObjectOutputStream objectOut = new ObjectOutputStream(fileOut);
        ...
        try
        {
            FileOutputStream fileOut = new FileOutputStream("C:\\Users\\xuan_\\IdeaProjects\\PJDemo5\\"+name+"\\randomGameMode\\randomBlock3.txt");
            ObjectOutputStream objectOut = new ObjectOutputStream(fileOut);
        ...
        try {
            FileOutputStream fileOut = new FileOutputStream("C:\\Users\\xuan_\\IdeaProjects\\PJDemo5\\"+name+"\\randomGameMode\\randomBlock4.txt");
            ObjectOutputStream objectOut = new ObjectOutputStream(fileOut);
        ...
        try {
            FileOutputStream fileOut = new FileOutputStream("C:\\Users\\xuan_\\IdeaProjects\\PJDemo5\\"+name+"\\randomGameMode\\randomBlock5.txt");
            ObjectOutputStream objectOut = new ObjectOutputStream(fileOut);
        ...
        try
        {
            FileOutputStream fileOut = new FileOutputStream("C:\\Users\\xuan_\\IdeaProjects\\PJDemo5\\"+name+"\\randomGameMode\\randomBlock6.txt");
            ObjectOutputStream objectOut = new ObjectOutputStream(fileOut);
        ...
        try
        {
            FileOutputStream fileOut = new FileOutputStream("C:\\Users\\xuan_\\IdeaProjects\\PJDemo5\\"+name+"\\randomGameMode\\randomBlock7.txt");
            ObjectOutputStream objectOut = new ObjectOutputStream(fileOut);
    ...
    public void readRandomBlock(String name)
    {
        try
        {
            FileInputStream fileIn = new FileInputStream("C:\\Users\\xuan_\\IdeaProjects\\PJDemo5\\"+name+"\\randomGameMode\\randomBlock1.txt");
            ObjectInputStream objectIn = new ObjectInputStream(fileIn);
        ...
        try
        {
            FileInputStream fileIn = new FileInputStream("C:\\Users\\xuan_\\IdeaProjects\\PJDemo5\\"+name+"\\randomGameMode\\randomBlock2.txt");
            ObjectInputStream objectIn = new ObjectInputStream(fileIn);
        ...
        try
        {
            FileInputStream fileIn = new FileInputStream("C:\\Users\\xuan_\\IdeaProjects\\PJDemo5\\"+name+"\\randomGameMode\\randomBlock3.txt");
            ObjectInputStream objectIn = new ObjectInputStream(fileIn);
        ...
        try
        {
            FileInputStream fileIn = new FileInputStream("C:\\Users\\xuan_\\IdeaProjects\\PJDemo5\\"+name+"\\randomGameMode\\randomBlock4.txt");
            ObjectInputStream objectIn = new ObjectInputStream(fileIn);
        ...
        try
        {
            FileInputStream fileIn = new FileInputStream("C:\\Users\\xuan_\\IdeaProjects\\PJDemo5\\"+name+"\\randomGameMode\\randomBlock5.txt");
            ObjectInputStream objectIn = new ObjectInputStream(fileIn);
        ...
        try
        {
            FileInputStream fileIn = new FileInputStream("C:\\Users\\xuan_\\IdeaProjects\\PJDemo5\\"+name+"\\randomGameMode\\randomBlock6.txt");
            ObjectInputStream objectIn = new ObjectInputStream(fileIn);
        ...
        try
        {
            FileInputStream fileIn = new FileInputStream("C:\\Users\\xuan_\\IdeaProjects\\PJDemo5\\"+name+"\\randomGameMode\\randomBlock7.txt");
            ObjectInputStream objectIn = new ObjectInputStream(fileIn);
    ...
    {
        File dir=new File("C:\\Users\\xuan_\\IdeaProjects\\PJDemo5\\score");
        if(!dir.exists())
            dir.mkdir();
        File dirMode=new File("C:\\Users\\xuan_\\IdeaProjects\\PJDemo5\\score\\"+mode);
        if(!dirMode.exists())
            dirMode.mkdir();

        try
        {
            fout = new FileOutputStream("C:\\Users\\xuan_\\IdeaProjects\\PJDemo5\\score\\"+mode+"\\"+name+".txt");
            dout = new DataOutputStream(fout);
            dout.writeInt(game.score);
    ...
    {
        File file = new File("C:\\Users\\xuan_\\IdeaProjects\\PJDemo5\\score\\"+mode);
        if (file.exists())
        {
